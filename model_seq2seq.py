# -*- coding: utf-8 -*-
"""
Created on Fri Apr  3 01:05:44 2020
...
def train():
    ...
    with val_graph.as_default():
        ...
        model_val = vedio2text(vocab_num=vocab_num,lr=FLAGS.learning_rate)
    ...
    samp_prob = 1/(1 + np.e**(np.arange(-2.0, 2.0, (4.0/FLAGS.num_epoches))))
        ...
        for i in range(0, num_steps):
            ...
            if i % FLAGS.num_display_steps == 1:
                ...
                print("\n[Train. Prediction] Epoch " + str(epo) + ", step " \
                        + str(i) + "/" + str(num_steps) + "......")
                #dec_print_train(p, caption_lens_batch, label_batch, datasetTrain.idx_to_word, FLAGS.batch_size, id_batch)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--save_dir', type=str, default='save_model/')    
    ...
    parser.add_argument('--data_dir', type=str, default=('/home/lingyis/DLhw2/MLDS_hw2_1_data'))
    parser.add_argument('--test_dir', type=str, default=('/home/lingyis/DLhw2/MLDS_hw2_1_data/testing_data'))
